...
params1 = ['-u', '13450731364', '-p', 'hlf234', '-d', '2023-11-05', '-a', '上午'] # 两个一小
params2 = ['-u', '18770858815', '-p', 'hlf890', '-d', '2023-11-05', '-a', '下午场一'] # 两个一小
params3 = ['-u', '18620624943', '-p', 'hlf369', '-d', '2023-11-05', '-a', '下午场二'] # 两个一小
params4 = ['-u', '13242964111', '-p', 'hlf132', '-d', '2023-11-05', '-a', '上午'] # 两个2小
params5 = ['-u', '13927472887', '-p', '236464', '-d', '2023-11-05', '-a', '下午场一'] # 两个2小
params6 = ['-u', '15999553637', '-p', '676711', '-d', '2023-11-05', '-a', '下午场二']  # 两个2小
# params7 = ['-u', '18172856581', '-p', 'wq6666', '-d', '2023-11-04', '-a', '晚上']  # 两个2小
